 ...
 */
  ...
  var
    ...
    /** @name angular */
    angular = window.angular || (window.angular = {}), angularModule, nodeName_, uid = 0;
  /**
 ...
 */
  function angularInit(element, bootstrap) {
    var elements = [element], appElement, module, config = {}, names = [
        'ng:app',
        'ng-app',
        'x-ng-app',
        'data-ng-app'
      ], options = { 'boolean': ['strict-di'] }, NG_APP_CLASS_REGEXP = /\sng[:\-]app(:\s*([\w\d_]+);?)?\s/;
 ...
 */
  ...
  function $CompileProvider($provide, $$sanitizeUriProvider) {
    var hasDirectives = {}, Suffix = 'Directive', COMMENT_DIRECTIVE_REGEXP = /^\s*directive\:\s*([\d\w_\-]+)\s+(.*)$/, CLASS_DIRECTIVE_REGEXP = /(([\d\w_\-]+)(?:\:([^;]+))?;?)/, ALL_OR_NOTHING_ATTRS = makeMap('ngSrc,ngSrcset,src,srcset');
   ...
   */
     ...
     */
        function $interpolate(text, mustHaveExpression, trustedContext, allOrNothing) {
          ...
          var startIndex, endIndex, index = 0, separators = [], expressions = [], parseFns = [], textLength = text.length, hasInterpolation = false, hasText = false, exp, concat = [], lastValuesCache = {
              values: {},
              results: {}
            };
              ...
              if (!stable) {
                ...
                if (oneTimeParseFn.$$unwatch && self && self.$$postDigestQueue) {
                  self.$$postDigestQueue.push(function () {
                    ...
                    if ((stable = isDefined(lastValue)) && (lastValue === null || !lastValue.$$unwrapTrustedValue)) {
  ...
  function $RootScopeProvider() {
     ...
     */
        Scope.prototype = {
          ...
          $watchGroup: function (watchExpressions, listener) {
            ...
            forEach(watchExpressions, function (expr, i) {
              ...
              deregisterFns.push(self.$watch(exprFn, function (value, oldValue) {
                ...
                changeCount++;
                if (unwatchFlags[i] && !exprFn.$$unwatch)
                  unwatchCount++;
                if (!unwatchFlags[i] && exprFn.$$unwatch)
                  unwatchCount--;
          ...
          $digest: function () {
            var watch, value, last, watchers, asyncQueue = this.$$asyncQueue, postDigestQueue = this.$$postDigestQueue, length, dirty, ttl = TTL, next, current, target = this, watchLog = [], stableWatchesCandidates = [], logIdx, logMsg, asyncTask;
            beginPhase('$digest');
            lastDirtyWatch = null;
            do {
              // "while dirty" loop
                      ...
                      try {
                        ...
                        if (watch) {
                          if ((value = watch.get(current)) !== (last = watch.last) && !(watch.eq ? equals(value, last) : typeof value === 'number' && typeof last === 'number' && isNaN(value) && isNaN(last))) {
                            ...
                            if (watch.get.$$unwatch)
                              stableWatchesCandidates.push({
                                watch: watch,
                                array: watchers
                              });
 ...
 */
  ...
  var VALID_CLASS = 'ng-valid', INVALID_CLASS = 'ng-invalid', PRISTINE_CLASS = 'ng-pristine', DIRTY_CLASS = 'ng-dirty', UNTOUCHED_CLASS = 'ng-untouched', TOUCHED_CLASS = 'ng-touched';
  /**
 * @ngdoc type
          ...
          link: function ($scope, $element, $attr, ctrl, $transclude) {
            ...
            $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
              var index, length, previousNode = $element[0],
                ...
                nextBlockMap = {}, arrayLength, key, value,
...
*/
angular.module('GlobalModule', []).controller('HelloCtrl', [
  '$scope',
  function ($scope) {
    $scope.name = 'World';
  }
...
]).controller('TextAreaWithLimitCtrl', [
  '$scope',
  function ($scope) {
